...
start:
        ...
        invoke printf, <"%5s|%50s|%8s", 10, 13, 0>, 'PID', 'Process name', 'Threads'
        invoke printf, <"%5s|%50s|%8s", 10, 13, 0>, '', '', ''
proc_loop:
        invoke printf, <'%5d|%50s|%8d', 10, 13, 0>, [procEntry.th32ProcessID], procEntry.szExeFile, [procEntry.cntThreads]
